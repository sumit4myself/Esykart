...
package com.webientsoft.esykart.api.offer.service.client;
...
@FeignClient(Services.OFFER_SERVICE)
public interface OfferServiceClient extends CrudServiceClientWithSearch<OfferModel> {
