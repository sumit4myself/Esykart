...
package com.webientsoft.esykart.api.order.service.client;
...
@FeignClient(Services.ORDER_SERVICE)
public interface OrderServiceClient extends CrudServiceClientWithSearch<OrderModel> {
