...
public class CustomerRestController extends CrudControllerWithSearch<CustomerModel>{
	...
	public ResponseEntity<CustomerModel> authenticate(
			@RequestBody AuthenticationModel model) {
		return customerService.authenticate(model);
	}
	...
	@Override
	protected CrudService<CustomerModel> getService() {
