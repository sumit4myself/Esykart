...
public interface LayoutServiceClient extends CrudServiceClientWithSearch<LayoutModel> {

	@RequestMapping(value = "/defaultLayout", method = RequestMethod.GET, consumes = {
		"application/json" }, produces = { MediaTypes.HAL_JSON_VALUE })
