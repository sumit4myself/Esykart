...
INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES ('&#xE919', null , 2, 'Catalogue', null);
	...
	INSERT INTO menu(icon, link, sort_index, title, parent_id)  VALUES (null, 'restricted.category_attribute.manage' , 1, 'Category Attribute', (select menu_id from menu where title = 'Catalogue'));
			...
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:delete(id_val)',(select menu_id from menu where link = 'restricted.category_attribute.manage'),( select privilege_id from privilege where privilege_name = 'Delete' ));
	...
	INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES (null, 'restricted.category.manage' , 2, 'Category', (select menu_id from menu where title = 'Catalogue'));
			...
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:delete(id_val)',(select menu_id from menu where link = 'restricted.category.manage'),( select privilege_id from privilege where privilege_name = 'Delete' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:activate(id_val)',(select menu_id from menu where link = 'restricted.category.manage'),( select privilege_id from privilege where privilege_name = 'Activate' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:deactivate(id_val)',(select menu_id from menu where link = 'restricted.category.manage'),( select privilege_id from privilege where privilege_name = 'Deactivate' ));
	...
	INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES (null, 'restricted.product.manage' , 3, 'Product', (select menu_id from menu where title = 'Catalogue'));
			...
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:delete(id_val)',(select menu_id from menu where link = 'restricted.product.manage'),( select privilege_id from privilege where privilege_name = 'Delete' ));
	...
	INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES (null, 'restricted.product_detail.manage' , 4, 'Product Detail', (select menu_id from menu where title = 'Catalogue'));
			...
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:delete(id_val)',(select menu_id from menu where link = 'restricted.product_detail.manage'),( select privilege_id from privilege where privilege_name = 'Delete' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:activate(id_val)',(select menu_id from menu where link = 'restricted.product_detail.manage'),( select privilege_id from privilege where privilege_name = 'Activate' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:deactivate(id_val)',(select menu_id from menu where link = 'restricted.product_detail.manage'),( select privilege_id from privilege where privilege_name = 'Deactivate' ));
	...
	INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES (null, 'restricted.sku.manage' , 5, 'SKU', (select menu_id from menu where title = 'Catalogue'));
			...
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:delete(id_val)',(select menu_id from menu where link = 'restricted.sku.manage'),( select privilege_id from privilege where privilege_name = 'Delete' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:activate(id_val)',(select menu_id from menu where link = 'restricted.sku.manage'),( select privilege_id from privilege where privilege_name = 'Activate' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:deactivate(id_val)',(select menu_id from menu where link = 'restricted.sku.manage'),( select privilege_id from privilege where privilege_name = 'Deactivate' ));
...
INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES ('&#xE54E;', null , 3, 'Pricing', null);
	INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES (null, 'restricted.offer.manage' , 1, 'Offers', (select menu_id from menu where title = 'Pricing'));
			...
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:delete(id_val)',(select menu_id from menu where link = 'restricted.offer.manage'),( select privilege_id from privilege where privilege_name = 'Delete' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:activate(id_val)',(select menu_id from menu where link = 'restricted.offer.manage'),( select privilege_id from privilege where privilege_name = 'Activate' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:deactivate(id_val)',(select menu_id from menu where link = 'restricted.offer.manage'),( select privilege_id from privilege where privilege_name = 'Deactivate' ));
...
INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES ('&#xE7F2;', null , 4, 'Customer Care', null);
	...
	INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES (null, 'restricted.order.manage' , 1, 'Orders', (select menu_id from menu where title = 'Customer Care'));
			...
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:delete(id_val)',(select menu_id from menu where link = 'restricted.order.manage'),( select privilege_id from privilege where privilege_name = 'Delete' ));
...
INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES ('&#xE912;', null , 5, 'Store Setting', null);
	...
	INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES (null, 'restricted.store_banner.manage' , 1, 'Banner', (select menu_id from menu where title = 'Store Setting'));
			...
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:delete(id_val)',(select menu_id from menu where link = 'restricted.store_banner.manage'),( select privilege_id from privilege where privilege_name = 'Delete' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:activate(id_val)',(select menu_id from menu where link = 'restricted.store_banner.manage'),( select privilege_id from privilege where privilege_name = 'Activate' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:deactivate(id_val)',(select menu_id from menu where link = 'restricted.store_banner.manage'),( select privilege_id from privilege where privilege_name = 'Deactivate' ));
	...
	INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES (null, 'restricted.store_icon.manage' , 2, 'Icon', (select menu_id from menu where title = 'Store Setting'));
			...
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:delete(id_val)',(select menu_id from menu where link = 'restricted.store_icon.manage'),( select privilege_id from privilege where privilege_name = 'Delete' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:activate(id_val)',(select menu_id from menu where link = 'restricted.store_icon.manage'),( select privilege_id from privilege where privilege_name = 'Activate' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:deactivate(id_val)',(select menu_id from menu where link = 'restricted.store_icon.manage'),( select privilege_id from privilege where privilege_name = 'Deactivate' ));
	...
	INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES (null, 'restricted.store_layout.manage' , 3, 'Layout', (select menu_id from menu where title = 'Store Setting'));
			...
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:delete(id_val)',(select menu_id from menu where link = 'restricted.store_layout.manage'),( select privilege_id from privilege where privilege_name = 'Delete' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:activate(id_val)',(select menu_id from menu where link = 'restricted.store_layout.manage'),( select privilege_id from privilege where privilege_name = 'Activate' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:deactivate(id_val)',(select menu_id from menu where link = 'restricted.store_layout.manage'),( select privilege_id from privilege where privilege_name = 'Deactivate' ));
	...
	INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES (null, 'restricted.store_menu.manage' , 4, 'Menu', (select menu_id from menu where title = 'Store Setting'));
			...
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:delete(id_val)',(select menu_id from menu where link = 'restricted.store_menu.manage'),( select privilege_id from privilege where privilege_name = 'Delete' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:activate(id_val)',(select menu_id from menu where link = 'restricted.store_menu.manage'),( select privilege_id from privilege where privilege_name = 'Activate' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:deactivate(id_val)',(select menu_id from menu where link = 'restricted.store_menu.manage'),( select privilege_id from privilege where privilege_name = 'Deactivate' ));
	...
	INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES (null, 'restricted.store_page.manage' , 5, 'Page', (select menu_id from menu where title = 'Store Setting'));
			...
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:delete(id_val)',(select menu_id from menu where link = 'restricted.store_page.manage'),( select privilege_id from privilege where privilege_name = 'Delete' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:activate(id_val)',(select menu_id from menu where link = 'restricted.store_page.manage'),( select privilege_id from privilege where privilege_name = 'Activate' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:deactivate(id_val)',(select menu_id from menu where link = 'restricted.store_page.manage'),( select privilege_id from privilege where privilege_name = 'Deactivate' ));
...
INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES ('&#xE32A;', null , 6, 'Users', null);
	...
	INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES (null, 'restricted.merchant.manage' , 1, 'Merchant', (select menu_id from menu where title = 'Users'));
			...
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:delete(id_val)',(select menu_id from menu where link = 'restricted.merchant.manage'),( select privilege_id from privilege where privilege_name = 'Delete' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:activate(id_val)',(select menu_id from menu where link = 'restricted.merchant.manage'),( select privilege_id from privilege where privilege_name = 'Activate' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:deactivate(id_val)',(select menu_id from menu where link = 'restricted.merchant.manage'),( select privilege_id from privilege where privilege_name = 'Deactivate' ));
	...
	INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES (null, 'restricted.user.manage' , 2, 'User', (select menu_id from menu where title = 'Users'));
			...
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:delete(id_val)',(select menu_id from menu where link = 'restricted.user.manage'),( select privilege_id from privilege where privilege_name = 'Delete' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:activate(id_val)',(select menu_id from menu where link = 'restricted.user.manage'),( select privilege_id from privilege where privilege_name = 'Activate' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:deactivate(id_val)',(select menu_id from menu where link = 'restricted.user.manage'),( select privilege_id from privilege where privilege_name = 'Deactivate' ));
	...
	INSERT INTO menu(icon, link, sort_index, title, parent_id) VALUES (null, 'restricted.role.manage' , 3, 'Role', (select menu_id from menu where title = 'Users'));
			...
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:delete(id_val)',(select menu_id from menu where link = 'restricted.role.manage'),( select privilege_id from privilege where privilege_name = 'Delete' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:activate(id_val)',(select menu_id from menu where link = 'restricted.role.manage'),( select privilege_id from privilege where privilege_name = 'Activate' ));
			INSERT INTO permission(link,menu_id, privilege_id) VALUES ('javascript:deactivate(id_val)',(select menu_id from menu where link = 'restricted.role.manage'),( select privilege_id from privilege where privilege_name = 'Deactivate' ));
