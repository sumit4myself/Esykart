...
INSERT INTO layout (name,default_layout,start_date,end_date,banner_id,nav_menu_id) values('Default Layout',true,'2016-01-01 00:00:00','2017-01-01 00:00:00',(select id FORM banner where name = 'Home Page Banner'),(select id FORM nav_menu where name = 'Default Menu'))
